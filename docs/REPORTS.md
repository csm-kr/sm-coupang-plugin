...
| `resourcing-exact-identity-relaxed` | `reports/deprecated/2026/2026-07-16/resourcing-exact-identity-relaxed/` |

현재 실행은 [HDB-1 시각 스토리보드·수치형 QA](../reports/2026/2026-07-16/hdb1-visual-storyboard-qa/report.md)다. 이전 [승인 제품기획](../reports/deprecated/2026/2026-07-16/hdb1-product-planning-phase1/product-plan-draft.md)과 별도 [승인 콘텐츠기획](../reports/deprecated/2026/2026-07-16/hdb1-product-planning-phase1/content-plan-draft.md)은 삭제하지 않고 보관 경로에 남긴다.
