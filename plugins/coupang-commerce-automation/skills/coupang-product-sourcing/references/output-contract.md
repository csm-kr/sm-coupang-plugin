...
표준 또는 조건부 마진과 나머지 필수 기준을 통과한 상품을 모아 사용자에게 선택권을 제공한다. 표준·조건부 수는 분리해 표시하고, 조건부 후보에는 사용자 승인 전 자동 승격 금지를 명시한다. 각 행에는 도매꾹 상품 URL, 쿠팡 근거 URL, 공급가, 추천가, 시장 중앙값, 정상 마진, 10% 가격 하락 후 마진, 수요·경쟁·운영 근거를 포함한다.
